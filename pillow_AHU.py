...
print('当前文件夹：', pwd)
data_set_list = os.listdir('./data/test/drone')  # 所有数据文件夹列表：00 01 02 ...
...
for data_set in data_set_list:
    # print(data_set)
    path = pwd + '/data/test/drone/' + data_set  # ./data/train/drone/00
    print('path =', path)
    ...
    for image in image_set:
        ...
        obj_dir = '/home/biyisi/PycharmProjects/pythonProject/data/test/new_drone/' + data_set + '/'
